...
class UpdatePropertyUseCase:
    ...
    def __init__(
        self, property_repository, location_repository, property_type_repository
    ):
    ...
    def execute(
        self, property_id: UUID, provider_id: UUID, updates: dict[str, Any]
    ) -> Property:
        """
        Update a property
        """
        ...
        if "property_type_id" in updates:
            property_type = self.property_type_repository.get_by_id(
