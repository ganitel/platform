...
class UserCreateRequest(BaseModel):
    ...
    email: Optional[EmailStr] = Field(None, description="User email (required if phone not provided)")
    phone: Optional[str] = Field(None, pattern=r"^\+\d{1,15}$", description="Phone number in international format (required if email not provided)")
    password: Optional[str] = Field(None, min_length=8, description="Password (required for email registration)")
...
class ForgotPasswordRequest(BaseModel):
    ...
    phone: Optional[str] = Field(None, pattern=r"^\+\d{1,15}$", description="Phone number in international format")
